---
title: "March Madness v3"
author: "Chris Lewis and Tyler Wellener"
date: "3/13/2017"
...
suppressWarnings(library(hybridEnsemble))
...
#for (i in 2013:2016) {
#  predictions = rbind(predictions, all_matchups(i)) 
#}
#predictions 
#predictions_rf = predict(rf_model, newdata = predictions, type = "prob")
#predictions2 = predictions_rf[,1]
#subfile = data.frame(id = predictions2$Matchup, pred = predictions2)
